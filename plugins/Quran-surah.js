...
// Translate tafsir from Bahasa Indonesia to Kiswahili
let translatedTafsirKiswahili = await translate(json.data.tafsir.id, { to: 'sw', autoCorrect: true });
...
${translatedTafsirKiswahili.text}\n
🔮 *Explanation (English):*\n
