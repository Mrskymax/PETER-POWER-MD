...
`;
 ...
 smd({
   ...
   try {
     ...
     if (!_0x155c01.includes("addstickers")) {
       return await _0x19df48.reply("_Hey! I am Peter Power Md Please Enter a Valid tg sticker url_\nEg: .tgs https://t.me/addstickers/Oldboyfinal");
     }
   ...
   async (message, url) => {
     try {
       ...
       if (!url.includes("addstickers")) {
         return await message.reply(
           "_Hey! I am Peter Power Md Please Enter a Valid tg sticker url_\nEg: .tgs https://t.me/addstickers/Oldboyfinal"
         );
       }
       ...
       for (let i = startIndex - 1; i < endIndex; i++) {
         ...
         if (isSticker) {
           ...
           await message.reply(
             sticker,
             { packname: Config.packname, author: "Peter-power-Md" },
             "sticker"
           );
         } else {
     ...
     try {
       ...
       if (!_0x1c586e) {
         return await _0x1ae8f8.reply(
           "*Provide Repo Url, _.gitclone https://github.com/Mrskymax/Peter-power-Md_*"
         );
       }
       const _0x5906ab =
 ...
 smd({
   ...
   try {
     ...
     if (!_0x204f81) {
       return _0x55aba2.reply("*_Example : .tts Hi,I am Peter-power-Md whatsapp bot._*");
     }
     try {
       ...
       await _0x55aba2.bot.sendMessage(_0x55aba2.jid, {
         ...
         mimetype: "audio/mpeg",
         ptt: true,
         fileName: "Peter-power-Md-tts.m4a"
       }, {
         quoted: _0x55aba2
       });
     } catch (_0x3537cb) {
   ...
   async (message, url) => {
     try {
       ...
       if (!/tiktok/.test(tiktokUrl)) {
         return await message.reply(
           "*Hey! I am Peter Power Md Please, Give me Valid Tiktok Video Url!*"
         );
       }
 ...
 smd(
   ...
   async (m, query) => {
     try {
       ...
       return m.reply("Hey! I am Peter Power Md Please, Give me a Name. Ex .pintrest apple");
     }
   }
 );
 smd(
   ...
   async (m, url) => {
     try {
       ...
       const caption = `『 *PETER-POWER-ᴍᴅ Mᴇᴅɪᴀғɪʀᴇ Dᴏᴡɴʟᴏᴀᴅᴇʀ* 』\n\n *Name* : ${result.name}\n *Size* : ${result.size}\n *Mime* : ${result.mime}\n\n\n${Config.caption}`;
       const textstyleCaption = await textstyletext(caption, 25);
       const contextInfo = {
...
smd({
 ...
 smd({
   ...
   if (!_0x4fe91c || !_0x2758ec[0]) {
     return await _0x3f8930.reply("*_Hey! I am Peter Power Md Please, Provide youtube video url!_*");
   }
   try {
 ...
 cmd({
   ...
   if (_0xb75e78.quoted && _0xb75e78.text) {
     ...
     if (_0x5b8ee5[0].includes("PETER-POWER-ᴍᴅ • sᴏɴɢ ᴅᴏᴡɴʟᴏᴀᴅᴇʀ")) {
     ...
     } else if (_0x5b8ee5[0].includes("PETER-POWER-ᴍᴅ • ʏᴏᴜᴛᴜʙᴇ ᴅᴏᴡɴʟᴏᴀᴅ")) {
     ...
     } else if (_0x5b8ee5[0].includes("PETER-POWER-ᴍᴅ • ᴀᴘᴋ ᴅᴏᴡɴʟᴏᴀᴅ ʟɪsᴛ")) {
...
smd({
  ...
  try {
    ...
    try {
      ...
      let _0x452f00 = _0x5c3baf.title || _0x57ada1 || _0x13f167[0x1] || "Peter-power Md -- YT Video";
      if (_0x57ada1) {
