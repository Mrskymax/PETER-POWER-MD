...
const {
 ...
 smd({
   ...
   try {
     ...
     if (!_0x47ed60) {
       return await _0x466dd8.reply("*_Hey! I am Peter Power Md Please, provide group link_*");
     }
 ...
 smd({
   ...
   try {
     ...
     if (!_0x3e5033) {
       return await _0x4f7c88.reply("*_Hey! I am Peter Power Md Please, provide group link_*");
     }
