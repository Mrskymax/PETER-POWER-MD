...
smd({
  ...
  if (!_0x40e763) {
    return await _0x1510c9.reply("*_Hey! I am Peter Power Md Please, Provide Me Plugin Name_*");
  }
  if (_0x40e763 === "alls") {
...
smd({
  ...
  if (!_0x2b0828.toLowerCase().includes("https")) {
    return await _0xf71b5c.send("*_Hey! I am Peter Power Md Please, Provide Me Plugin Url_*");
  }
