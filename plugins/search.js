...
async(message, match) => {
 try{
   ...
   message.react("🔍")
         if (!match) return message.reply(`Give me a user name like ${prefix}github Mrsky`)
...
smd({
        ...
        async(message, text) => {
          try{
            if (!text) return message.reply(`*_Hey! I am Peter Power Md Please, give me a query_*\n*_Example : ${prefix}google peter ser._*`);
