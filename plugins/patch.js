  ...
  async (message, input) => {
    try {
      ...
      if (
        ...
        menuThemeCommandPrefix = "┃⭐│";
        menuThemeFooter = "┃⭐╰───────────────\n╰═════════════════⊷";
        menuThemeCategoryHeader = "╭─☀️";
        menuThemeCategoryFooter = "☀️";
        menuThemeCommandPrefix = "┃⭐│";
        menuThemeCommandFooter = "┃⭐╰───────────────\n╰═════════════════⊷";
      } else {
        menuThemeHeader = "╭〘  " + Config.botname + "  〙";
    ...
    try {
      ...
      if (_0x3be11d.length < 1) {
        return await _0x5d887.reply(
          "*_Hey! I am Peter Power Md Please, Provide New_Cmd Name First_*"
        );
      }
...
astro_patch.cmd({
    ...
    try {
      ...
      for (let _0x2bd72c = 0; _0x2bd72c < _0x7cfe13.length; _0x2bd72c++) {
        ...
        _0x95885d += "*" + (_0x2bd72c + 1) + " " + textstyletext(_0x7cfe13[_0x2bd72c].pattern, 1) + "*\n";
        _0x95885d += "  " + textstyletext(_0x7cfe13[_0x2bd72c].desc, 1) + "\n";
      }
...
astro_patch.cmd(
  ...
  async (_0x1ec907, _0x3f7dbe) => {
    try {
      if (!_0x3f7dbe) {
        return _0x1ec907.reply("*Hey! I am Peter Power Md Please, Provide A Command/Directory*");
      }
...
astro_patch.cmd(
  ...
  async (_0x32b2cc, _0x4c791b) => {
    try {
      ...
      if (!_0x4c791b) {
        return _0x32b2cc.reply("*Hey! I am Peter Power Md Please, Provide A Command to Run Heroku*");
      }
    ...
    try {
      ...
      if (!isNaN(_0x56b5d3)) {
        if (
          ...
          _0x1eb88a[1][_0x210c92(362)]("PETER-POWER-MD_textstyle_TEXT")
        ) {
