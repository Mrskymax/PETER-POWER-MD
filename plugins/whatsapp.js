...
cmd(
  ...
  async (_0x235a20, _0x3f96d6, { cmdName: _0x31c746 }) => {
    try {
      if (!_0x235a20.quoted) {
        return await _0x235a20.send("*Hey! I am Peter Power Md Please, reply to video*");
      }
...
cmd(
  ...
  async (_0x23a729, _0x5ad999, { cmdName: _0x2cb44f }) => {
    try {
      ...
      if (!_0x48ef43) {
        return await _0x23a729.send("*Hey! I am Peter Power Md Please, reply to to a Message*");
      }
