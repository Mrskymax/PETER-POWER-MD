...
smd({
  ...
  try {
    ...
    if (!_0xad98fb || _0xad98fb?.mtype != "stickerMessage") {
      return await _0x471740.reply("*Hey! I am Peter Power Md Please, Reply to sticker*");
    }
...
smd({
  ...
  try {
    ...
    if (!_0x5b20bd || !pmtypes.includes(_0x5b20bd.mtype)) {
      return _0x29b369.reply("*Hey! I am Peter Power Md Please, Reply to an image*");
    }
...
smd({
  pattern: "textstyle",
  desc: "Makes stylish/textstyle given text",
  category: "converter",
  use: "56 WASI MD V2",
  filename: __filename
}, async (_0x230c03, _0x3b568a) => {
  try {
    let _0x365550 = "┏━━━━━━━━━━━━━━━━━━━━━━━━\n┃\t*PETER-POWER-MD-FANCY-TEXT💬* \n┗━━━━━━━━━━━━━━━━━━━━━━━━\n\n " + (_0x3b568a ? "```🔢Reply the number you wants to select``` \n\n" : "```\t\t" + prefix + "textstyle Asta(For all text)\n\t\t" + prefix + "textstyle 25 Asta(For specific text)```\n\n");
    ...
    let _0x564034 = await textstyletext("" + _0x3b568a.slice(2), _0x50c7d9);
    return await _0x230c03.send(_0x564034, {}, "", _0x230c03);
  } catch (_0x8dd389) {
    return await _0x230c03.error(_0x8dd389 + "\n\ncmdName: textstyle", _0x8dd389);
  }
});
smd({
  pattern: "tiny",
...
smd({
  ...
  try {
    ...
    if (!_0x462db2 || !audtypes.includes(_0x462db2?.mtype)) {
      return _0x5c9aa3.reply("*_Hey! I am Peter Power Md Please, Reply to audio/video_*");
    }
  ...
  try {
    ...
    if (_0x2cee76) {
      ...
      if (_0x374825 && !isNaN(_0x374825)) {
        _0x2cee76 = await textstyletext("" + _0x2cee76.slice(2), _0x374825);
      }
      const {
