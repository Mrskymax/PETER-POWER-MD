...
let disabledperma = ["addbot", "addlist", "stoprent", "disableadd", "enableadd", "setsudo", "delsudo", "newvar", "delvar", "setvar", "update", "updatenow", "restart", "reboot"];
const {
  userdb,
  smd,
  fetchJson,
...
try {
  ...
  smd({
    ...
    use: "[ PETER-POWER : how can i help you! ]",
      ...
      const designs = [
        async () => {
          const imageBuffer = await axios.get(
            "https://od.lk/s/NzhfNjc1ODI2OTNf/456508666_2508413256010868_5347041524312197800_n.jpg",
            {
...
smd({
  ...
  try {
    if (!_0x65bfc2.quoted) {
      return await _0x65bfc2.reply("Hey! I am Peter Power Md Please, Reply to Audio/Video To Add In Bgm");
    }
    if (!_0x324d8f) {
      return await _0x65bfc2.reply("Hey! I am Peter Power Md Please give Bgm Song NAme");
    }
    let _0x5e225e = false;
    let _0x44e871 = "";
...
let textstyle_converter = async _0x443889 => {
  ...
  if (_0x2f7616) {
    ...
    _0x59fa9e = await textstyle(_0x59fa9e, _0x19c9c2 - 1);
  }
...
events.cmd({
  ...
  try {
    ...
    if (!_0x5ae18a) {
      return await _0x2bd5d0.reply("*Please follow the below option!*\n    _" + prefix + "addbot qr/pair |" + _0x2bd5d0.senderNum + "_\n    _" + prefix + "addbot session scan_Id_\n");
    }
...
events.cmd({
  ...
  try {
    ...
    if (!_0x14cff4 || !_0x14cff4[0]) {
      return await _0x48b928.reply("*There's no user has addd 'WASI md'!*");
    }
...
events.cmd({
  ...
  try {
    ...
    if (!_0x34f1e0) {
      return await _0x5d40b9.reply("*Please reply/mention User(who have addd bot) to stop addd bot!*");
    }
    ...
    if (_0x5ad48c !== -1) {
      ...
      return await _0x5d40b9.reply("*add bot successfully LOGOUT from @" + _0x34f1e0.split("@")[0] + " !*", {
        mentions: [_0x34f1e0]
      });
    } else {
      return await _0x5d40b9.reply("*There's no user who has addd 'WASI md'!*");
    }
  } catch (_0x5bad57) {
...
events.cmd({
  cmdname: "disableadd",
  desc: "Disable cmds for add bot users!",
  ...
  try {
    if (!_0x2d6ee3) {
      return _0x52616f.reply("*provide cmdName to disable for add user!*");
    }
    let _0x41fff7 = global.renters;
    if (!_0x41fff7 || !_0x41fff7[0]) {
      return await _0x52616f.reply("*_No user has rent 'WASI md' yet!_*\n*_Can't disable cmds for addd users, If the bot is not addd!_*");
    }
    ...
    if (global.rentdisable.includes(_0x197a22.pattern)) {
      return await _0x52616f.reply("*'" + _0x197a22.pattern + "' already disabled for addd users!*");
    }
    global.rentdisable.push(_0x197a22.pattern);
    return await _0x52616f.reply("*'" + _0x197a22.pattern + "' Successfuly disabled for addd users!*");
  } catch (_0x3d3f70) {
...
events.cmd({
  ...
  try {
    ...
    if (global.rentdisable.includes(_0x44129c.pattern)) {
      ...
      return await _0xb03e25.reply("*'" + _0x44129c.pattern + "' Successfuly enable for addd users!*");
    } else {
  ...
  setTimeout(() => {
    ...
    async function _0x347a1f() {
      ...
      const _0x1a9455 = SuhailMDConnect({
        ...
        browser: _0x235024.type === "pair" ? ["Mac OS", "Safari", "3.1.0"] : ["add [WASI] by [" + Config.ownername + "]", "Chrome", "1.0.0"],
      ...
      _0x1a9455.ev.on("connection.update", async _0x4e5a92 => {
        try {
          ...
          if (_0x3d78c6 === "open") {
            ...
            let _0x1221e4 = "┌───🔅\n🌟  [PETER-POWER SHARING RUNNING] \n🌟  Prefix : [ " + (prefix || "null") + " ]\n🌟  Mode : " + Config.WORKTYPE + "\n🌟  Plugins : " + events.commands.length + "";
            await _0x8bf7a7.reply("*add MODE*\n*Now @" + _0x517212 + " Have own whatsapp bot!*:", {
              mentions: [_0x459047]
            }, "smd");
            ...
            await _0x1a9455.sendMessage(_0x459047, {
              ...
              contextInfo: {
                externalAdReply: {
                  title: "Peter-power Sharing",
                  sourceUrl: "https://m.me/ch/AbbbaKkM-dWkgJ99"
                }
              }
            }, {
