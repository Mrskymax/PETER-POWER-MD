...
smd({
  ...
  try {
    ...
    await _0x28a796.error(_0x166d80 + "\n\ncommand: removebg", _0x166d80, "*_No responce from remove.bg, Sorry!!_*");
  }
});
smd({
  pattern: "readmore",
...
smd({
  ...
  try {
    let {
      data: _0x44f98c
    } = await axios.get("https://api.github.com/repos/Mrskymax/Peter-power-Md");
    let _0x1c73f9 = ("\nPeter-power-Md AN CHUDDY BUDDY BOT FOR ENJOYMENT *" + Config.ownername + "*.\n\n  *❲🌟❳ Stars:* " + (_0x44f98c?.stargazers_count || "120+") + " stars\n  *❲🌟❳ Forks:* " + (_0x44f98c?.forks_count || "1000+") + " forks\n  *❲🌟❳ Authors:* Mrskymax\n  *❲🌟❳ Created On:* " + (_0x44f98c?.created_at || "undefined") + "\n  *❲🌟❳ Repo:* _https://github.com/Mrskymax/Peter-power-Md_\n  *❲🌟❳ Scan:* _" + scan + "_" + (Config.caption ? "\n\n" + Config.caption : "")).trim();
...
smd({
  ...
  try {
    ...
    if (!_0xd9b857.includes("x")) {
      return _0x165087.send("*You did not add x in number.*\n*Ex: " + prefix + "advertisement 234902786xx,Your_Message_here*  \n " + Config.caption);
    }
...
smd({
  ...
  try {
    ...
    if (_0x48975a[0]) {
      ...
      _0x5f656f = "*Peter-power-Md• ᴀɴɴᴏɴʏᴍᴏᴜs ᴍsɢ*\n\n*Msg_Id:* " + _0x3079e2.id + "\n*Date:* _" + _0xbcd286 + "_\n*Time:* _" + _0x47ad13 + "_\n\n*Message:* " + _0x5f656f + "\n\n\n" + Config.caption;
...
smd({
  ...
  try {
    if (_0x2acf30.quoted && isAnnonyMsgAlive.includes(_0x2acf30.sender) && _0x2acf30.text.length > 2) {
      ...
      if (_0x2acf30.reply_text.includes("Peter-power-Md• ᴀɴɴᴏɴʏᴍᴏᴜs ᴍsɢ") && _0x2dfb59[0].includes("Peter-power-Md• ᴀɴɴᴏɴʏᴍᴏᴜs ᴍsɢ") && _0x2dfb59[2].includes("Msg_Id")) {
