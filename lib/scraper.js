...
async function textstyle(_0x5b1e58, _0x13e0d0) {
  try {
    let _0x1830de = await ftextstyle(_0x5b1e58);
    return _0x1830de[_0x13e0d0].result;
  } catch (_0x40ef2a) {
    console.log(_0x40ef2a);
  }
}
async function randomtextstyle(_0x5c5181) {
  try {
    let _0x5ac180 = await ftextstyle(_0x5c5181);
    return _0x5ac180[0].result;
  } catch (_0x61d17) {
    console.log("ERRO IN RANDOME textstyle SCRAPPER\n", _0x61d17);
    return _0x5c5181;
  }
}
    ...
    axios.get("https://sfmcompile.club/page/" + _0x6f78c6).then(_0x4d532c => {
      ...
      _0x3596b1("#primary > div > div > ul > li > article").each(function (_0xbb4011, _0x525d04) {
        _0x4210e7.push({
          ...
          add_count: _0x3596b1(_0x525d04).find("header > div.entry-after-title > p > span.entry-adds").text(),
